...
def _insert_markets(conn: sqlite3.Connection) -> None:
    ...
    rows = [
        (
            "polymarket", "MKT_A", "ev-a", "sports", 2_000_000, 5000.0,
            "complete", None, 0, 0, None, 1_700_000_000, None, None, None, None, None,
        ),
        (
            "polymarket", "MKT_B", "ev-b", "esports", 2_000_500, 7000.0,
            "complete", None, 0, 0, None, 1_700_000_000, None, None, None, None, None,
        ),
        (
            "polymarket", "MKT_C", "ev-c", "politics", 2_001_000, 3000.0,
            "complete", None, 0, 0, None, 1_700_000_000, None, None, None, None, None,
        ),
        (
            "polymarket", "MKT_D", "ev-d", "sports", 0, 1000.0,
            "complete", None, 0, 0, None, 1_700_000_000, None, None, None, None, None,
        ),
    ]
    conn.executemany(
